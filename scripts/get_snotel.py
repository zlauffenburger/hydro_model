...
def get_snotel(start_date, end_date, json_file="../data/swecoords.json", out_name="../data/snotel_swe_2007-2017.csv"):
    """
...
# example to run code:
get_snotel("2007-09-01", "2017-08-31", "../data/swecoords.json", "../data/snotel_swe_2007-2017.csv")
